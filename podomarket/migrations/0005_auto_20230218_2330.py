# Generated by Django 2.2 on 2023-02-18 14:30
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('podomarket', '0004_auto_20230129_1912'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='user',
            name='nickname',
            field=models.CharField(error_messages={'unique': '使えないユーザーネームです。'}, max_length=15, null=True, unique=True, validators=[podomarket.validators.validate_no_special_characters]),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('item_condition', models.CharField(choices=[('새제품', '新品'), ('최상', '美品'), ('상', '上'), ('중', '中'), ('하', '下')], max_length=10)),
